...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const typed = new Typed('#typed-name', {
    strings: ['Absor', 'Pro Player', 'zama', 'Harith Main'],
    typeSpeed: 100,
    backSpeed: 50,
    backDelay: 2000,
    startDelay: 500,
  ...
  window.addEventListener('scroll', function() {
    ...
    const parallaxElements = document.querySelectorAll('.profile-image-wrapper, .hero-title');
  ...
  // CONSOLE MESSAGE
  // ==============================
  console.log('%c🎮 Welcome to my Gaming Portfolio! 🎮', 'font-size: 20px; color: #4facfe; font-weight: bold; text-shadow: 2px 2px 4px rgba(0,0,0,0.3);');
  console.log('%cTry the Konami Code for a surprise! ↑ ↑ ↓ ↓ ← → ← → B A', 'font-size: 14px; color: #f093fb;');
